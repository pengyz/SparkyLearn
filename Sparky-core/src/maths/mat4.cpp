...
vec3 sparky::maths::mat4::multiply(const vec3 & other)const
{
    return vec3(
...
vec4 sparky::maths::mat4::multiply(const vec4 & other)const
{
    return vec4(
...
mat4 mat4::rotation(float angle, const vec3 & aixs)
{
    mat4 result(1.0f);
...
mat4 sparky::maths::operator*(mat4 left, const mat4 & right)
{
    return left.multiply(right);
}

vec4 sparky::maths::operator*(mat4 left, const vec4 & right)
{
    return left.multiply(right);
}

vec3 sparky::maths::operator*(mat4 left, const vec3 & right)
{
    return left.multiply(right);
}
